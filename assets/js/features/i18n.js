...
(function () {
    ...
    const RU_INLINE = {
        ...
        "petdecor.progress": "Интерьер комнаты: {done}/{total} предметов открыто",
        "petdecor.plant.title": "Цветок",
        "petdecor.plant.desc": "Украшает комнату питомца.",
        "petdecor.bed.title": "Кровать",
        "petdecor.bed.desc": "Уютное место для отдыха питомца.",
        "petdecor.toys.title": "Игрушки",
        "petdecor.toys.desc": "Весёлый уголок для игры.",
        "petdecor.confirm.title": "Открыть предмет?",
        "petdecor.confirm.text": "Открыть «{item}» за {price} монет?",
        "petdecor.bought": "{item} открыт! 🎉",
        "petdecor.already_opened": "Этот предмет уже открыт ✅",
        "petdecor.no_coins": "Не хватает {coins} 🪙",
        "petdecor.need_more": "Нужно ещё {coins} монет 🪙",
        "petdecor.opened_hint": "{item} уже стоит в комнате 🏠",
        "petdecor.aria_opened": "{item} открыт",
        "petdecor.aria_locked": "{item} закрыт. Цена {price} монет",
    ...
    const EN_INLINE = {
        ...
        "petdecor.progress": "Room decor: {done}/{total} items unlocked",
        "petdecor.plant.title": "Plant",
        "petdecor.plant.desc": "Decorates your pet room.",
        "petdecor.bed.title": "Bed",
        "petdecor.bed.desc": "A cozy place for your pet to rest.",
        "petdecor.toys.title": "Toys",
        "petdecor.toys.desc": "A fun corner for play time.",
        "petdecor.confirm.title": "Unlock item?",
        "petdecor.confirm.text": "Unlock “{item}” for {price} coins?",
        "petdecor.bought": "{item} unlocked! 🎉",
        "petdecor.already_opened": "This item is already unlocked ✅",
        "petdecor.no_coins": "Missing {coins} 🪙",
        "petdecor.need_more": "Need {coins} more coins 🪙",
        "petdecor.opened_hint": "{item} is already in the room 🏠",
        "petdecor.aria_opened": "{item} unlocked",
        "petdecor.aria_locked": "{item} locked. Price {price} coins",
